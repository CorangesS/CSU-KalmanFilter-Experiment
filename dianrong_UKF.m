...
for k=1:N-1
    ...
    x(:,k+1)=[x1+T/C1*31+w1; x2+T/C1*31+w2];
...
%3.计算k时刻的一步预测模型值
    ...
    for i=1:5
        ...
        xsigmapre(:,i)=[xsigma(1,i)+T/C1*31; xsigma(2,i)+T/C1*31];        
    end
    xkpre=xsigmapre*wm';
    Pkpre=Q;
    for i=1:5
...
%5.计算k时刻的预测量测值
    ...
    for i=1:5
       ...
       zsigmapre(:,i)=[xsigma(1,i)+31*R0; xsigma(2,i)+31*R0];
    end
    zkpre=zsigmapre*wm';
    Pzzk=R;
    Pxzk=zeros(2);
